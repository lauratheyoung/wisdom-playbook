...
def trait_plots(uuid, user_row, TRAIT_COLS, TRAIT_RANGES, user_peer_data):
    ...
    for trait in desired_order:
        ...
        pie_fig.update_layout(title=dict(text=f"{trait}", font=dict(family='Inter, sans-serif', size=25, color='black')), legend=dict(orientation='h',yanchor='top',y=0.005,xanchor='left',x=0.05))
